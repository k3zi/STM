...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-STM/IQKeyboardManager.framework"
  ...
  install_framework "Pods-STM/ObjectMapper.framework"
  install_framework "Pods-STM/PRTween.framework"
  install_framework "Pods-STM/PureLayout.framework"
  install_framework "Pods-STM/RAMPaperSwitch.framework"
  install_framework "Pods-STM/Realm.framework"
  install_framework "Pods-STM/RealmSwift.framework"
  install_framework "Pods-STM/Reusable.framework"
  install_framework "Pods-STM/SAConfettiView.framework"
